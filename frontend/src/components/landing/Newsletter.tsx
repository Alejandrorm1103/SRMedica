const Newsletter = () => {
  return (
    <div className="-mt-32 mb-8 relative z-10 box-border px-4">
        ...
        <div className="grid grid-cols-1 gap-y-10 gap-x-6 lg:grid-cols-2 xl:gap-x-8">
          ...
          <div className="p-10 flex flex-col justify-center">
            ...
            <h4 className="text-base font-normal mb-7 text-offwhite">
              Recibe las últimas noticias sobre salud, consejos médicos y
              actualizaciones de nuestra plataforma directamente en tu correo.
            </h4>
